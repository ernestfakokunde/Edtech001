...
function RepositoryUpload({ onUploaded }: { onUploaded: () => void }) {
  ...
  async function upload() {
    ...
    try {
      ...
      setError(reason instanceof Error ? reason.message : "Could not upload the paper.");
    } finally {
      setBusy(false);
    }
  }
  ...
  async function submit() {
    ...
    try {
      ...
      setError(reason instanceof Error ? reason.message : "Could not submit the paper.");
    } finally {
      setBusy(false);
    }
  }
